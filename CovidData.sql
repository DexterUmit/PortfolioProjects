...
-- Global death percentage of population
select SUM(population) as population, sum(new_deaths) as totalDeaths , SUM(new_deaths)/SUM(population)*100 as DeathPercentage
from deaths
where continent is not null
order by 1, 2;
